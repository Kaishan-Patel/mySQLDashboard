...
You'll need to grab the installer for [MAMP](https://www.mamp.info/en/) and install it. You'll want to use the MAMP installer and not the MAMP Pro version that also comes installed. 
